...
petition_with_missing_key = correct_petition.copy()
del petition_with_missing_key[createdOn_key]

petition_with_wrong_user_id = correct_petition.copy()
petition_with_wrong_user_id[createdBy_key] = 55

petition_with_wrong_date_format = correct_petition.copy()
...
petition_with_no_evidence = correct_petition.copy()
