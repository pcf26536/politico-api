...
from api.ver2.utils.strings import user_id_key, vote_key, office_id_key
...
def votes():
    fields = [user_id_key, createdBy_key, createdOn_key, candidate_key, office_id_key]
