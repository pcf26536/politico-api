...
user_with_wrong_name_format = user_with_correct_signup_data
user_with_wrong_name_format[lname] = '@@@##'

user_with_wrong_mail_format = user_with_correct_signup_data
user_with_wrong_mail_format[email] = '3##%##dfdfefdfd.cdfdf'

user_with_wrong_pass_length = user_with_correct_signup_data
user_with_wrong_pass_length[password_1] = short_pass
user_with_wrong_pass_length[password_2] = short_pass

user_with_unmatching_passwords = user_with_correct_signup_data
user_with_unmatching_passwords[password_1] = correct_pass
user_with_unmatching_passwords[password_2] = correct_pass + '$%D'

user_with_wrong_passport_url = user_with_correct_signup_data
user_with_wrong_passport_url[pspt] = 'fgrgfgfgf'

user_with_wrong_phone_format = user_with_correct_signup_data
